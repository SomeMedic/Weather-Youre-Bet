              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: '${roundDegree ? widget.degree.round() : widget.degree}',
                      ...
                      TextSpan(
                        text: statusData.getDegree(''), // Используем метод для получения единицы измерения
                        style: context.textTheme.displayLarge?.copyWith(
                          fontSize: 70, // Уменьшенный размер шрифта для единицы измерения
                          fontWeight: FontWeight.w800,
                          shadows: const [
                            Shadow(
                              blurRadius: 15,
