...
import 'package:weatherbet/app/ui/home.dart';
import 'package:weatherbet/app/ui/onboarding.dart';
import 'package:weatherbet/theme/theme.dart';
import 'package:weatherbet/theme/theme_controller.dart';
import 'package:weatherbet/translation/translation.dart';
import 'package:weatherbet/app/utils/device_info.dart';
...
ThemeMode getThemeModeBasedOnTime() {
  final now = DateTime.now();
  final startLightTheme = TimeOfDay(hour: 7, minute: 0);
  final endLightTheme = TimeOfDay(hour: 18, minute: 0);

  if (now.hour >= startLightTheme.hour && now.hour < endLightTheme.hour) {
